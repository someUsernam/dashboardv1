...
import { addOnProducts, pricingCards } from "@/lib/consts";
...
async function Page({ params }: Props) {
	...
	const prices = await stripe.prices.list({
		product: process.env.NEXT_WEBSITE_BUILDER_PRODUCT_ID,
		active: true,
	});
	...
	const charges = await stripe.charges.list({
		customer: String(agencySubscription?.customerId),
		limit: 100,
	});
	...
	return (
		<>
          ...
          further question contact support@exemple-app.com"
